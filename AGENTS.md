...
This document contains mandatory rules for AI coding agents working on this repository.
...
* **Dependency Locking:**
  * When adding or upgrading Go packages, ensure their minimum Go version requirement is ≤ 1.24.
